...
class ReleaseBuilder
{
    ...
    public function toXml()
    {
        ...
        $srcfiles = array_merge($srcfiles, array_map('basename', glob(__DIR__ . '/../*.{c,h}', GLOB_BRACE)));
    ...
    private function testFiles()
    {
        return array_map(function ($file) {
            return str_replace($this->rootDir . '/tests/', '', $file);
        }, glob($this->rootDir . '/tests/**/*.{php,phpt}', GLOB_BRACE));
    }
}

$releaseBuilder = new ReleaseBuilder(__DIR__ . '/../releases.yaml');

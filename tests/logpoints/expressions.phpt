--TEST--
Stackdriver Debugger: Expressions in logpoints should be replaced in message
--FILE--
<?php

// set a snapshot for line 12 in loop.php (return $sum)
var_dump(stackdriver_debugger_add_logpoint('loop.php', 12, 'INFO', 'Logpoint hit! 0: $0, 1: $1', [
    'expressions' => [
        '3 + 3',
        '$i'
    ]
...
array(1) {
  [0]=>
  string(25) "Logpoint hit! 0: 6, 1: 10"
}

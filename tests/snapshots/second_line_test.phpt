--TEST--
Stackdriver Debugger: Line number test. Breakpoint is set on the blank line
after the local variable is set.
--FILE--
<?php

// set a snapshot for line 5 in line_numbers.php
var_dump(stackdriver_debugger_add_snapshot('line_numbers.php', 5));
